...
- **Reference:** `site/client/js/itm_report.js`
...
- **Reference:** `site/views/itmReport/index.php`
...
- **Reference:** `site/client/js/store/itm_report.js`
...
- **Reference:** `site/client/js/components/itm_report/itm_upsert_modal.vue`
...
- **Reference:** `site/client/css/pages/_itm_report.scss`
...
- `site/client/js/itm_report.js`
- `site/client/js/store/itm_report.js`
- `site/client/js/components/itm_report/itm_report_header.js`
- `site/client/js/components/itm_report/itm_table.js`
- `site/client/js/components/itm_report/itm_upsert_modal.vue`
...
**Reference Implementation:** `site/client/js/itm_report.js`
...
**Reference Implementation:** `site/client/js/store/itm_report.js`
...
**Reference Implementation:** `site/client/js/components/itm_report/itm_report_header.js`
...
**Reference Implementation:** `site/client/js/components/itm_report/itm_table.js`
...
### Sidebar Styling:
**Reference Implementation:** `site/client/css/pages/_itm_report.scss` (lines 15-25)
...
- `site/client/js/components/itm_report/itm_upsert_modal.vue` (lines 87-189)
- `site/client/js/components/itm_report/components/itm_new_address_modal.vue` (grid layout examples)

### Sidebar Navigation Patterns:

**Reference Implementation:** `site/client/js/components/itm_notification_setting/itm_notification_setting_section_menu.vue`
...
**Reference Structure:** `site/client/js/components/itm_notification_setting/itm_notification_setting_section_menu.vue` (lines 14-61)
...
**Reference Implementation:** `packages/ui-vue/src/components/tabs-line/tabs-line.vue`
...
**Reference Implementation:** `packages/ui-vue/src/components/tabs-buttons/tabs-buttons.vue`
...
**Reference Structure:** `packages/ui-vue/src/components/tabs-line/tabs-line.vue` (lines 61-67)
...
**Reference Implementation:** `site/client/js/components/itm_notification_setting/components/itm_reference_documentation.vue`
...
**Reference Implementation:** `site/client/js/components/itm_report/components/systems_table.js`
...
- **Single Actions:** `site/client/js/components/itm_report/itm_table.js` (lines 53-77)
- **System Actions:** `site/client/js/components/itm_report/components/systems_table.js` (lines 50-71)
...
**Reference Implementation:**
- **Main Table:** `site/client/js/components/itm_report/itm_table.js` (not explicit columns, uses server config)
- **Systems Table:** `site/client/js/components/itm_report/components/systems_table.js` (lines 76-165)
...
**Reference Implementation:** `site/client/js/components/itm_notification_setting/components/itm_add_reference_documentation.vue`
...
**Study Pattern:** `site/client/js/components/itm_notification_setting/components/itm_add_reference_documentation.vue`
...
**Reference Implementation:** `site/client/js/components/itm_report/itm_upsert_modal.vue`
...
**Reference Implementation:** `site/client/css/pages/_itm_report.scss`
...
**Study:** `site/client/css/pages/_itm_report.scss` - Notice how minimal the custom styles are. Most functionality comes from UI components themselves.
...
**Reference Implementation:** `site/views/itmReport/index.php`
...
#### 9. **Tabs Navigation**
- **Location:** `packages/ui-vue/src/components/tabs-line/tabs-line.vue`, `tabs-buttons/tabs-buttons.vue`
...
**Reference Implementation:** `site/client/js/components/itm_report/components/itm_new_address_modal.vue`
...
- `site/client/js/components/itm_report/itm_table.js` (lines 55-67)
- `site/client/js/components/itm_report/itm_report_header.js` (lines 26-31)
- `packages/ui-vue/src/components/index.js` - Check available icons in UI-Vue library
...
- `site/client/js/components/itm_report/itm_report_header.js` (lines 37-63): Breakpoint usage
...
- `site/client/js/components/itm_report/itm_report_header.js` (lines 51-56): Debounced resize handling
...
- `site/client/js/components/itm_notification_setting/itm_notification_setting_section_menu.vue` (lines 23, 32, 41, 49, 58)
- `packages/ui-vue/src/components/tabs-line/tabs-line.vue` (line 153) - `v-bind:test-id="option.testId"`
...
3. **`site/client/js/components/itm_report/itm_upsert_modal.vue`** - Modal component composition
4. **`site/views/itmReport/index.php`** - PHP view integration and asset management
5. **`site/client/css/pages/_itm_report.scss`** - Minimal CSS override philosophy
